...
Understandably, a lot of developers don't understand how, exactly, requests are routed and queued. It isn't simple. Here's the gist of what most Rails devs already understand about Heroku does it {% marginnote "<img src='https://i.imgur.com/zy0XzzZ.gif'><br><i>'So the router load balances the Unicorns? Or the Pumas?'</i>" %}:
